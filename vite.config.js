  ...
  return {
    ...
    resolve: {
      alias: [
        ...
        // pure module instead — deliberately not an alias to server/, which
        // would put db.js and the signing keys one import away from client code.
        { find: '@promo', replacement: resolve('./server/promo.js') },
      ],
    },
